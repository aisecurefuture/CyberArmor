...
const CHANNEL_ID = "aishields-alerts";

export function configureNotifications(): void {
  PushNotification.configure({
    onRegister: (token) => {
      console.log("CyberArmor.ai Push Token:", token);
    },
    onNotification: (notification) => {
      console.log("CyberArmor.ai Notification:", notification);
    },
    ...
    PushNotification.createChannel(
      {
        ...
        channelName: "CyberArmor.ai Security Alerts",
        channelDescription: "Critical security alerts from CyberArmor.ai Protect",
