"""
CyberArmor.ai Protect - Microsoft Sentinel Output
...
Events are written to a custom log type (default: CyberArmor.aiProtect_CL).
"""
...
class SentinelOutput(SIEMOutput):
    ...
    def _log_type(self) -> str:
        return self._config.get("SENTINEL_LOG_TYPE", "CyberArmor.aiProtect")
    ...
    def _transform_event(self, event: dict[str, Any]) -> dict[str, Any]:
        """Map a normalized CyberArmor.ai event to a Sentinel-friendly document.
            ...
            test_doc = [
                {
                    ...
                    "Title": "CyberArmor.ai Sentinel connectivity test",
        ...
        return {
            ...
            "properties": {
                ...
                "SENTINEL_LOG_TYPE": {
                    "type": "string",
                    "description": (
                        "Custom log type name (default: CyberArmor.aiProtect). "
