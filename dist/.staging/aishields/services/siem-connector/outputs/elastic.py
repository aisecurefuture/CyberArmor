"""
AIShields Protect - Elastic SIEM Output
...
# Index template mapping for AIShields events using ECS
_INDEX_TEMPLATE = {
    ...
    "composed_of": [],
    "_meta": {
        "description": "AIShields Protect security events (ECS-compatible)",
    },
}
...
class ElasticOutput(SIEMOutput):
    ...
    def _map_to_ecs(self, event: dict[str, Any]) -> dict[str, Any]:
        """Map a normalized AIShields event to Elastic Common Schema."""
        ...
        doc: dict[str, Any] = {
            ...
            "tags": event.get("tags", []),
            "observer": {
                "product": event.get("product", "AIShields Protect"),
                "vendor": "AIShields",
