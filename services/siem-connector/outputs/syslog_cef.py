"""
AIShields Protect - Generic Syslog / CEF Output
...
# Syslog severity from AIShields severity
...
class SyslogCEFOutput(SIEMOutput):
    ...
    def _build_cef(self, event: dict[str, Any]) -> str:
        ...
        # CEF header fields
        vendor = _escape_cef_header("AIShields")
        ...
        name = _escape_cef_header(event.get("title", "AIShields Event"))
    ...
    async def test_connection(self) -> bool:
        ...
        try:
            test_cef = (
                "CEF:0|AIShields|Protect|1.0.0|test|"
                "Connectivity Test|1|msg=AIShields syslog connectivity test"
            )
