/**
 * AIShields RASP — C/C++ Runtime Application Self-Protection
 * LD_PRELOAD-based interception for AI/LLM API calls.
 *
 * Usage: LD_PRELOAD=libaishields_rasp.so ./your_application
 */

#ifndef AISHIELDS_RASP_H
#define AISHIELDS_RASP_H
...
typedef enum {
    AISHIELDS_MODE_MONITOR = 0,
    AISHIELDS_MODE_BLOCK   = 1,
} aishields_mode_t;
 ...
 *   AISHIELDS_URL, AISHIELDS_API_KEY, AISHIELDS_TENANT, AISHIELDS_MODE
...
typedef void (*aishields_event_cb)(const char *event_type, const char *url,
