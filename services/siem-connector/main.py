"""
AIShields Protect - SIEM Connector Service

Receives security events from all AIShields services and routes them
...
class SecurityEvent(BaseModel):
    """Incoming security event from any AIShields service."""
...
# ---------------------------------------------------------------------------
app = FastAPI(
    title="AIShields Protect - SIEM Connector",
...
async def send_test_event(
    ...
    test_event = SecurityEvent(
        ...
        title="AIShields SIEM Connector Test Event",
