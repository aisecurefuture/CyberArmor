...
logger = logging.getLogger("aishields.monitors.file")
...
class _CyberArmor.aiEventHandler(FileSystemEventHandler):
...
class FileMonitor:
    ...
    async def run(self) -> None:
        ...
        handler = _CyberArmor.aiEventHandler(self._event_queue, loop)
